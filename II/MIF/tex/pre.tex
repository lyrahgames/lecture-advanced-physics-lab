...
\usepackage{titling}
\title{Protokoll: \\ Michelson-Interferrometer}
\author{Clemens Anschütz \\ Markus Pawellek}
% \email{markuspawellek@gmail.com}
\newcommand{\email}{clemens.anschuetz@uni-jena.de \\ markuspawellek@gmail.com}
...
\fancypagestyle{mainstyle}{
	...
	\fancyhead[LO,RE]{\footnotesize} %left
	\fancyhead[RO,LE]{\footnotesize \leftmark} %right
