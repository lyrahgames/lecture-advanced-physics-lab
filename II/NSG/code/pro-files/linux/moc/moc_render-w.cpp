...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RenderW_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 54, 5)
    ...
    "RenderW\0setVecField\0\0VecField2f*\0field\0"
    "setRandPosSize\0count\0"
};
...
void RenderW::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setVecField((*reinterpret_cast< VecField2f*(*)>(_a[1]))); break;
        case 1: _t->setRandPosSize((*reinterpret_cast< uint(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject RenderW::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RenderW.data,
      qt_meta_data_RenderW,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RenderW.stringdata))
